...
评测数据集由胸外科院士团队、主任医师团队与医工复合团队联合构建，本章节对数据集分布、题型构成、多模态数据格式及样例题进行说明。
### 3.1 胸外科数据集分布
| 场景               | 能力维度                 | 题目数量（道） |
|--------------------|--------------------------|----------------|
| 医学循证与知识      | 专科基础能力             | 1312       |
...
### 3.5 本次评测数据集
本次评测按照总量5%的比例对胸外科数据集进行抽样，数据集情况如下：
